...
export default class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ width: "100%", height: "100vh", background: "#050808", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", maxWidth: 480, padding: 32 }}>
          <div style={{ ...f1, fontSize: 24, color: "#FF6B6B", marginBottom: 16 }}>GAME OVER</div>
          ...
          <div style={{ ...f2, fontSize: 16, color: "#888", marginBottom: 24, background: "rgba(255,255,255,0.05)", padding: 12, borderRadius: 6, textAlign: "left", wordBreak: "break-word" }}>
