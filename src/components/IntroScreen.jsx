...
export default function IntroScreen({ onStart }) {
  return (
    <div onClick={onStart} style={{ width:"100%", height:"100vh", background:"radial-gradient(ellipse at center,#0f1a0f 0%,#050808 70%)", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", cursor:"pointer", position:"relative", overflow:"hidden", ...f1 }}>
      ...
      <IntroTypewriter />
      <div style={{ position:"absolute", bottom:30, fontSize:8, color:"#555", textAlign:"center", lineHeight:2, padding:"0 20px" }}>
